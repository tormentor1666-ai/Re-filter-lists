...
recipient = "serskvor1986.com@mail.ru"
subject = "Hello from Python!"
body = "This is a test email sent using a mailto link generated by Python."
cc = "tormentor1666@gmail.com"
bcc = "bcc@example.com"

# URL-encode the subject and body to handle special characters and spaces
encoded_subject = urllib.parse.quote_plus(subject)
encoded_body = urllib.parse.quote_plus(body)

# Construct the mailto link
mailto_link = f"mailto:{recipient}?subject={encoded_subject}&body={encoded_body}&cc={cc}&bcc={bcc}"

# Open the mailto link in the default web browser (which should trigger the email client)
webbrowser.open(mailto_link)

print(f"Opening mailto link: {mailto_link}")
